      ...
      <Layout headerStyle="newsletter" footerStyle="newsletter">
        ...
        <section className="section mt-60 newsletter-style">
          <div className="container-sub">
            <h4 className="title-favicon-newsletter color-brand-2 mb-25">
              What We Offer
            </h4>
              ...
              <div className="col-sm-4">
                <div className="card-offer card-offer-newsletter hover-up">
                  ...
                  <div className="card-info">
                    <h6 className="font-sm-bold color-brand-2 mb-10">
                      Sea Forwarding
                    </h6>
                    <p className="font-xxs color-grey-700 mb-20">
            ...
            <div className="row align-items-center">
              ...
              <div className="col-sm-6 mb-30">
                <div className="box-info-pround-newsletter">
                  <h6 className="font-md-bold color-brand-2 mb-10">
          ...
          <div className="container-sub">
            <div className="row align-items-center">
              <div className="col-sm-5">
                ...
                <p className="font-xxs color-grey-500 mb-20">
                ...
                <div className="mt-20">
                  {" "}
                  <Link
                    className="btn btn-brand-2 mr-20 font-xxs-medium"
                    href="/contact"
                  >
                    Contact Us
                  </Link>
                  <Link
                    className="btn btn-link-medium font-xxs-medium"
                    href="#"
                  >
                    Learn More
                    <svg
          ...
          <div className="container-sub position-relative">
            <div className="row">
              <div className="col-sm-6 pt-25 pb-25">
                ...
                <p className="font-xxs color-grey-900 mb-20">
                  Excepteur sint occaecat cupidatat non proident, sunt in culpa
                  qui officia deserunt mollit laborum — semper quis lectus
                  nulla. Interactively transform magnetic growth strategies
                  whereas prospective "outside the box" thinking.
                ...
                <div className="row">
                  <div className="col-lg-6 mb-20">
                    <h6 className="chart-title font-xxs-bold color-grey-900">
                      Boost your sale
                    </h6>
                    <p className="font-xxs color-grey-900">
                      The latest design trends meet hand-crafted templates.
                    </p>
                  </div>
                  <div className="col-lg-6 mb-20">
                    <h6 className="feature-title font-xxs-bold color-grey-900">
                ...
                <div className="mt-0">
                  {" "}
                  <Link
                    className="btn btn-brand-2 font-xxs mr-20"
                    href="/contact"
                  >
                    Contact Us
                  </Link>
