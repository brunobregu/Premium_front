export const routes = {
  ...
  logistics: {
    ...
    shipmentRequests: '/logistics/shipment-requests',
    myOrders: '/logistics/my-orders',
    users: '/logistics/dashboard/users',
    activeUsers: '/logistics/dashboard/active-users',
    nonActiveUsers: '/logistics/dashboard/non-active-users',
    roles: '/logistics/dashboard/roles',
    contacts: '/logistics/dashboard/contacts',
    ports: '/logistics/dashboard/ports',
    auctions: '/logistics/dashboard/auctions',
    providers: '/logistics/dashboard/providers',
    ...
    viewDocuments: (id: string) => `/logistics/shipments/${id}/uploaded-documents`
  },
  appointment: {
