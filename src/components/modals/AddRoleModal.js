...
const createRoleSchema = yup.object().shape({
  name: yup.string().required('Role name is required').min(1, 'At least 1 letter'),
});
    ...
    <Modal isOpen={isOpen} onRequestClose={handleClose} style={modalStyles} ariaHideApp={false}>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className='flex justify-between w-full gap-4'>
          <Button type="submit" className='flex-1' isLoading={createRoleMutation.isLoading}>Save</Button>
