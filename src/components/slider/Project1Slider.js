      ...
      >
          ...
          <div className="cardGrid">
            ...
            <div className="cardInfo">
              ...
              <p className="font-xs color-grey-500">
                {i18n.t('what-we-have-done-air-desc')}
              </p>
        ...
        <SwiperSlide className="wow animate__animated animate__fadeIn">
          <div className="cardGrid">
            ...
            <div className="cardInfo">
              <h5 className="color-brand-2 mb-10">
                {i18n.t('what-we-have-done-sea')}
              </h5>
              <p className="font-xs color-grey-500">
                {i18n.t('what-we-have-done-sea-desc')}
              </p>
            </div>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide className="wow animate__animated animate__fadeIn">
          <div className="cardGrid">
            ...
            <div className="cardInfo">
              <h5 className="color-brand-2 mb-10">
                {i18n.t('what-we-have-done-warehouse')}
              </h5>
              <p className="font-xs color-grey-500">
                {i18n.t('what-we-have-done-warehouse-desc')}
              </p>
              {/* <div className="box-button mt-30">
                <a className="btn btn-link font-sm color-brand-2">
                  View Details
